        ...
        auth.sendPasswordResetEmail(email)
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Snackbar snackBar = Snackbar.make(activity_forgot,"Enviamos um email de redefinição de senha para: "+email,Snackbar.LENGTH_LONG);
                            ...
                            Snackbar snackBar = Snackbar.make(activity_forgot,"Erro ao enviar email, verifique seus dados",Snackbar.LENGTH_LONG);
                            View view = snackBar.getView();
                            FrameLayout.LayoutParams params =(FrameLayout.LayoutParams)view.getLayoutParams();
                            params.gravity = Gravity.TOP;
                            view.setLayoutParams(params);
